...
function SearchForm({onSearch}) {
  ...
  return (
    <div>
        <h1 className='pt-5 text-7xl text-white font-michroma'>SONIFI</h1>
        ...
        <p className='text-2xl text-white font-kodachasan pt-3'>Discover new music based on your favorite artists and songs.</p>
        <form 
